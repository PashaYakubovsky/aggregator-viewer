...
class AggregatedItemViewerScene {
	...
	init(canvas: HTMLCanvasElement) {
		...
		const flame1Material = new THREE.SpriteMaterial({
			transparent: true,
		...
		const flame = new THREE.Sprite(flame1Material);
		flame.center.set(0.5, 0);
		flame.scale.x = 0.5; // optional
...
export default AggregatedItemViewerScene;
...
// 	const flame1Material = new THREE.SpriteNodeMaterial({
// 		transparent: true,
// 		side: THREE.DoubleSide
// 	});
...
// 	const flame2Material = new THREE.SpriteNodeMaterial({
// 		transparent: true,
// 		side: THREE.DoubleSide
// 	});
